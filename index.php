...
<body>
                        ...
                        <div class="main-menu">
                            <nav class="nav-menu">
                                <ul>
                                    ...
                                    <li><a href="php/gellary.php">Gellary</a></li>
                                    <li><a href="#contact">Contact</a></li>
									<li><a href="php/login.php">Login/singup</a></li>
                                </ul>
                            </nav>
                        </div>
                    </div>
    ...
    <section class="slider-area" id="home">
        <div id="P1" class="background-video" data-property="{videoURLs:'http://youtu.be/l_tHTmd5pgk',containment:'.slider-area',showControls:false,startAt:0,mute:false,autoPlay:true,loop:false,opacity:1}">
        </div>
        <div class="container">
            <div class="slider-content d-flex flex-center">
                <div class="col-md-8 col-sm-9 col-xs-12 d-flex flex-center">
                    <div class="slider-nner">
                        <h2>Perfect Development <br>Best For Your Application</h2>
                        <p>The Best Development For Your Mobile App and WebSite,Application  To Showcase And Acquire New Customers All Around The World!</p>
                        <div class="btn-area">
                            <a href="#contact">Keep Tech Now </a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 hidden-sm hidden-xs">
                    <div class="slider-m-img">
                        <img src="assets/img/mobile/sanjeev.jpg" height="1500" alt="mobile image">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-5 hidden-sm hidden-xs">
                    <div class="about-left-thumb">
                        <img src="assets/img/mobile/about.png" alt="mobile screen">
                    </div>
                </div>
    ...
    <section class="screen-slider-area ptb--120" id="screenshot">
        <div class="container">
            <div class="section-title text-black">
                <h2>MY PROJECTS</h2>
                <p>Hi myself sanjeev kumar I belong to rampur uttar pradesh india, I have been created this website show my profile and all projects details. my all project details link in below take it. and see </p>
            </div>
            <div class="row">
                <div class="screen-slider owl-carousel">
                    <img src="assets/img/mobile/screen-slider/calculator1.png" alt=" mobile screen">
					<img src="assets/img/mobile/screen-slider/cogent (113).jpg" alt=" mobile screen">
                    <img src="assets/img/mobile/screen-slider/cogent (114).jpg" alt=" mobile screen">
                    <img src="assets/img/mobile/screen-slider/cogent (125).jpg" alt=" mobile screen">
                    <img src="assets/img/mobile/screen-slider/contact1.png" alt=" mobile screen">
					<img src="assets/img/mobile/screen-slider/voter1.png" alt=" mobile screen">
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="team-area ptb--120">
        <div class="container">
            <div class="section-title text-black">
                <h2>Meet my team</h2>
                <p>That my team university period to be develop Voting Management System</p>
            </div>
            <div class="row">
                <div class="member-area">
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="team-item">
                            <img src="assets/img/team/sarika.jpg" alt="team image">
                            <div class="tmember-info">
                                <h4>Sarika Chaudhary</h4>
                                <span>Project Testing</span>
                                <p>That role to test whole project .his find the problem and sent me</p>
                                <div class="social-btns">
                                    <a href="https://www.facebook.com/sarika.chaudhary.752?epa=SEARCH_BOX"><i class="fa fa-facebook"></i></a>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="team-item">
                            <img src="assets/img/team/shashi.jpg" alt="team image">
                            <div class="tmember-info">
                                <h4>Shashi saini</h4>
                                <span>Project reports</span>
                                <p>That role prepare project all report by help sarika. report like(project summery ,SRS Report and Final report )</p>
                                <div class="social-btns">
                                    <a href="https://www.facebook.com/shashi.saini.14268"><i class="fa fa-facebook"></i></a>
                                    <a href="#"><i class="fa fa-twitter"></i></a>
                                    <a href="#"><i class="fa fa-tumblr"></i></a>
                                    <a href="#"><i class="fa fa-pinterest"></i></a>
                                </div>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="team-item">
                            <img src="assets/img/team/sanjeev1.jpg" alt="team image">
                            <div class="tmember-info">
                                <h4>Sanjeev Kumar</h4>
                                <span>developer</span>
                                <p>I was project developer so I am maintain whole project programming font-end / back-end </p>
                                <div class="social-btns">
                                    <a href="https://www.facebook.com/ssp9448"><i class="fa fa-facebook"></i></a>
                                    <a href="#"><i class="fa fa-twitter"></i></a>
                                    <a href="#"><i class="fa fa-tumblr"></i></a>
                                    <a href="#"><i class="fa fa-pinterest"></i></a>
                                </div>
